...
class SigninStudentView extends React.Component {
  static get Controller() {
    if (Controller) return Controller;

    try {
      Controller = require("..controllers/SigninStudentController");
      Controller = Controller.default || Controller;

      return Controller;
    } catch (e) {
      if (e.code == "MODULE_NOT_FOUND") {
        Controller = SigninStudentView;
  ...
  componentDidMount() {
    ...
    htmlEl.dataset["wfPage"] = "626642b80f31460be0b4f7ca";
  ...
  render() {
    const proxies =
      SigninStudentView.Controller !== SigninStudentView
    ...
    return (
      <span>
        <style
          ...
          @media (max-width:991px) and (min-width:768px) {html.w-mod-js:not(.w-mod-ix) [data-w-id=\"0a2fea0d-2e23-78ef-6613-c40f8c6a3d13\"] {-webkit-transform:translate3d(0, -105%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, -105%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, -105%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, -105%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);}}@media (max-width:767px) and (min-width:480px) {html.w-mod-js:not(.w-mod-ix) [data-w-id=\"0a2fea0d-2e23-78ef-6613-c40f8c6a3d13\"] {-webkit-transform:translate3d(0, -105%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, -105%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, -105%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, -105%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);}}@media (max-width:479px) {html.w-mod-js:not(.w-mod-ix) [data-w-id=\"0a2fea0d-2e23-78ef-6613-c40f8c6a3d13\"] {-webkit-transform:translate3d(0, -105%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, -105%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, -105%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, -105%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);}}
        `,
          }}
        />
                  ...
                  <div className="af-class-page-padding">
                    <div className="af-class-container">
                      <div className="w-layout-grid af-class-signin-signin">
                        <div id="w-node-_0a2fea0d-2e23-78ef-6613-c40f8c6a3d3d-e0b4f7ca">
                          <div className="af-class-signin-wrapper af-class-div-block">
                            <h2>Sign in</h2>
                            <p className="af-class-middle-align af-class-signin">
                              Sign in using different Wallets
                            </p>
                            <div className="af-class-is--flex af-class-middle">
                              <a
                                href="#"
                                className="af-class-auth-button af-class-metamask w-inline-block"
                              >
                                <img
                                  src="https://uploads-ssl.webflow.com/62546fa0d96e443a1867f458/625effa1230495ab7b61e5bf_logos_metamask.svg"
                                  loading="lazy"
                                  alt
                                />
                              </a>
                              <a
                                href="#"
                                className="af-class-auth-button af-class-temple w-inline-block"
                              >
                                <img
                                  src="https://uploads-ssl.webflow.com/62546fa0d96e443a1867f458/625f0048be8e8d8597a1bf3f_download.png"
                                  loading="lazy"
                                  alt
                                  className="af-class-temple-logo"
                                />
                              </a>
                            </div>
                            <div className="af-class-line" />
                            <p className="af-class-middle-align af-class-signin af-class-business">
                              Or{" "}
                              <Link to="/signin-business">
                                <span className="af-class-bold">
                                  Sign in here
                                </span>
                              </Link>
                        ...
                        <div
                          id="w-node-_0a2fea0d-2e23-78ef-6613-c40f8c6a3d4e-e0b4f7ca"
...
export default SigninStudentView;
